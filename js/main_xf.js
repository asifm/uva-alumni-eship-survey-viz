...
var AddXAxis, basic_num_format, k_num_format, percent_num_format, process_data, total_obs;
...
d3.csv('data/alum_xf.csv', process_data, function(data) {
  ...
  write_stat = function() {
    return $('#stat').text(percent_num_format(xf.groupAll().reduceCount().value() / total_obs));
  };
